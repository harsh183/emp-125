...
Let's move onto conditional expressions and statements.
...
Try adding an else statement to print "What can I help you with?". When will the else statement execute?
