...
Functions are pretty awesome. They let us *reuse code* when we have to do something over and over again. In general, functions take in input and *return* some output.
